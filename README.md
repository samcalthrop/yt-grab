...
```bash
curl -fsSL https://raw.githubusercontent.com/samcalthrop/yt-grab/main/install.sh | bash
```

## Windows

```pwsh
powershell -ExecutionPolicy Bypass -c "irm https://raw.githubusercontent.com/samcalthrop/yt-grab/main/install.ps1 | iex"
```
